...
if ( ! function_exists( 'dd_woocommerce_wrapper_after' ) ) {
	/**
	 * After Content.
	 *
...
add_action( 'woocommerce_after_main_content', 'dd_woocommerce_wrapper_after' );
 ...
 *
	<?php
		if ( function_exists( 'dd_woocommerce_header_cart' ) ) {
			dd_woocommerce_header_cart();
		}
	?>
 */

if ( ! function_exists( 'dd_woocommerce_cart_link_fragment' ) ) {
	/**
	 * Cart Fragments.
	 *
	 ...
	 */
	function dd_woocommerce_cart_link_fragment( $fragments ) {
		ob_start();
		dd_woocommerce_cart_link();
		$fragments['a.cart-contents'] = ob_get_clean();

		return $fragments;
	}
}
add_filter( 'woocommerce_add_to_cart_fragments', 'dd_woocommerce_cart_link_fragment' );

if ( ! function_exists( 'dd_woocommerce_cart_link' ) ) {
	/**
	 * Cart Link.
	 *
	 ...
	 * @return void
	 */
	function dd_woocommerce_cart_link() {
		?>
		<a class="cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'dd' ); ?>">
			<?php
...
if ( ! function_exists( 'dd_woocommerce_header_cart' ) ) {
	 ...
	 * @return void
	 */
	function dd_woocommerce_header_cart() {
		if ( is_cart() ) {
